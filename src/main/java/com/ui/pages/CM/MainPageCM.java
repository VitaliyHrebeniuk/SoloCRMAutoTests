...
public class MainPageCM extends BasePage {
    ...
    public MainPageCM(WebDriver webDriver) {
        super(webDriver);
    }

    public MainPageCM clickOnProfileButton() {
        findElement(webDriver, profileButton).click();
        return this;
    }

    public MainPageCM clickOnExitButton() {
        findElement(webDriver, exitButton).click();
        return this;
    }

    public MainPageCM clickOnYesWarningButton() {

...
public class GenerateUserTokenWith2FaForHeadControlUI {
    final String LOGIN_TRUE = "head_control_TEST_UI";
    ...
    public String set2faForAccount(){
        ...
        this.headControlTokenWith2FA = response.path("data.token").toString();
        return headControlTokenWith2FA;
    }
}

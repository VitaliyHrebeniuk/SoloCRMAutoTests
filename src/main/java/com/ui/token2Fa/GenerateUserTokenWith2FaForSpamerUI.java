...
public class GenerateUserTokenWith2FaForSpamerUI {
    final String LOGIN_TRUE = "spamer_TEST_UI";
    final String PASSWORD_TRUE = "132465798";
    public String spamerTokenWithout2FA;
    ...
    public String setUserTokenWithout2FA(){
        ...
        this.spamerTokenWithout2FA = response.path("data.token").toString();
        return spamerTokenWithout2FA;
    }
    ...
    public String generateUser2FACode(){
        ...
        this.spamer2FACode = response.path("data.security_code").toString();
        return spamer2FACode;
    }
    ...
    public String set2faForAccount(){
        this.spamer2FaCode = chief2FaCode();
        Response response = request
                .headers("token",setUserTokenWithout2FA())
                .post(URL+"security/verify/" + spamer2FaCode);
        this.spamerTokenWith2FA = response.path("data.token").toString();
        return spamerTokenWith2FA;
    }
}

...
public class GenerateUserTokenWith2FaForSearcherUI {
    final String LOGIN_TRUE = "searcher_TEST_UI";
    final String PASSWORD_TRUE = "132465798";
    public String searcherTokenWithout2FA;
    ...
    public String setUserTokenWithout2FA(){
        ...
        this.searcherTokenWithout2FA = response.path("data.token").toString();
        return searcherTokenWithout2FA;
    }
    ...
    public String generateUser2FACode(){
        ...
        this.searcher2FACode = response.path("data.security_code").toString();
        return searcher2FACode;
    }
    ...
    public String set2faForAccount(){
        this.searcher2FaCode = chief2FaCode();
        Response response = request
                .headers("token",setUserTokenWithout2FA())
                .post(URL+"security/verify/" + searcher2FaCode);
        this.searcherTokenWith2FA = response.path("data.token").toString();
        return searcherTokenWith2FA;
    }
}

...
public class ManagerCreateDealFixSMM {
    ...
    public void setDriver(){
        ...
        this.user2FaCode = generateUserTokenWith2FaForManager.manager2FaCode;
    }
    @Test
    public void createFixSMM() throws InterruptedException {
        // Login
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div/div/div[2]/form/div/div[2]/div[1]/div/input")).sendKeys(user2FaCode);

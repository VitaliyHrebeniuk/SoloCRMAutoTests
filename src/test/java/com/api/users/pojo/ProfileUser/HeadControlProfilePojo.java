...
public class HeadControlProfilePojo {
    @SerializedName("role")
    private String role = "head_control";
    @SerializedName("login")
    private String login = "head_control_API_TEST" + generateRandomNumber();

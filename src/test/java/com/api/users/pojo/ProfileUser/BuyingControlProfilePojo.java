...
public class BuyingControlProfilePojo {
    @SerializedName("role")
    private String role = "buying_control";
    @SerializedName("login")
    private String login = "buyingControl_API_TEST" + generateRandomNumber();

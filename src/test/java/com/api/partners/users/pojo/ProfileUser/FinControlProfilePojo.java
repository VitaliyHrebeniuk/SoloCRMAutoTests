...
public class FinControlProfilePojo {
    @SerializedName("role")
    private String role = "fin_control";
    @SerializedName("login")
    private String login = "fin_control_API_TEST" + generateRandomNumber();

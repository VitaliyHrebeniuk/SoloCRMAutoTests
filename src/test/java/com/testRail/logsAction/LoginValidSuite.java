...
public class LoginValidSuite extends BaseTest {
    ...
    @TestRails(id="33")
    @Test
    public void validTeamLeadLogin(){
        /**
         * Подключаем 2ФА и запоминаем код
         */
    ...
    @TestRails(id="37")
    @Test
    public void validBuyingControlLogin(){
        /**
         * Подключаем 2ФА и запоминаем код
         */
    ...
    @TestRails(id="40")
    @Test
    public void validFinControlLogin(){
        /**
         * Подключаем 2ФА и запоминаем код
         */
    ...
    @TestRails(id="42")
    @Test
    public void validHeadControlLogin(){
        /**
         * Подключаем 2ФА и запоминаем код
         */
    ...
    @TestRails(id="43")
    @Test
    public void validRetentionManagerLogin(){
        /**
         * Подключаем 2ФА и запоминаем код
         */
    ...
    @TestRails(id="44")
    @Test
    public void validRetentionTeamLeadLogin(){
        /**
         * Подключаем 2ФА и запоминаем код
         */
    ...
    @TestRails(id="45")
    @Test
    public void validRetentionSearcherLogin(){
        /**
         * Подключаем 2ФА и запоминаем код
         */
    ...
    @TestRails(id="46")
    @Test
    public void validRetentionSpamerLogin(){
        /**
         * Подключаем 2ФА и запоминаем код
         */
